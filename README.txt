...
a persistence unit "correccionWSCarritoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "correccionWSCarrito\pom.xml":
...
artifact ("correccionWSCarrito.war") is already built. You can build
